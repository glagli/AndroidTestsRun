        ...
        try:
            ...
            while flag != 0:
                ...
                if OpenSixtyMin.exists:
                    ...
                    print(f"{NowDate()}  Нажата кнопка 'Войти на 60 минут'")
                    f.write(f"{NowDate()}  Нажата кнопка 'Войти на 60 минут'\n")
                    sleep(6)
                    break
                if flag == 1:
                    print(f"{NowDate()}  Кнопка 'Войти на 60 минут' не найдена. Скрипт принудительно завершен ")
                    f.write(f"{NowDate()}  Кнопка 'Войти на 60 минут' не найдена. Скрипт принудительно завершен \n")
                    return
                else:
                    flag -= 1
                    sleep(3)
